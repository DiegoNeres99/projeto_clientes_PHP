        ...
        <div class="col-lg-10 col-xl-8">
            ...
            <div class="card">
                <div class="card-header bg-primary text-white text-center">
                    <h3 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Novo Produto</h3>
                </div>
                            ...
                            <div class="col-md-8">
                                <div class="form-floating">
                                    <input type="text" id="nome" name="nome" class="form-control"
                                        value="{{ old('nome') }}" placeholder="Nome do produto" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-floating">
                                    <select id="categoria" name="categoria" class="form-select" required>
                                        ...
                                        <option value="masculino" {{ old('categoria') == 'masculino' ? 'selected' : '' }}>Masculino</option>
                                        <option value="feminino" {{ old('categoria') == 'feminino' ? 'selected' : '' }}>Feminino</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="number" step="0.01" id="preco" name="preco"
                                        class="form-control" value="{{ old('preco') }}" placeholder="0.00" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="number" id="estoque" name="estoque" class="form-control"
                                        value="{{ old('estoque') }}" placeholder="0" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="text" id="material" name="material" class="form-control"
                                        value="{{ old('material') }}" placeholder="Material">
